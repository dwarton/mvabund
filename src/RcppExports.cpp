...
// RtoAnovaCpp
List RtoAnovaCpp(const List& rparam, RcppGSL::Matrix& Y, RcppGSL::Matrix& X, RcppGSL::Matrix& isXvarIn, Rcpp::Nullable& bID);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::Nullable& >::type bID(bIDSEXP);
    __result = Rcpp::wrap(RtoAnovaCpp(rparam, Y, X, isXvarIn, bID));
    return __result;
END_RCPP
}
// RtoGlmAnova
List RtoGlmAnova(const List& sparam, const List& rparam, RcppGSL::Matrix& Y, RcppGSL::Matrix& X, RcppGSL::Matrix& O, RcppGSL::Matrix& isXvarIn, Rcpp::Nullable& bID, RcppGSL::Vector& lambda);
...
// RtoGlmSmry
List RtoGlmSmry(const List& sparam, const List& rparam, RcppGSL::Matrix& Y, RcppGSL::Matrix& X, RcppGSL::Matrix& O, Rcpp::Nullable& bID, RcppGSL::Vector& lambda);
...
// RtoSmryCpp
List RtoSmryCpp(const List& rparam, RcppGSL::Matrix& Y, RcppGSL::Matrix& X, Rcpp::Nullable& bID);
