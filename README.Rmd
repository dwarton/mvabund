...
The goal of mvabund is to provide tools for a **model-based approach** to the analysis of multivariate abundance data in ecology [(Warton 2011)](https://besjournals.onlinelibrary.wiley.com/doi/10.1111/j.2041-210X.2012.00190.x). Abundance measures include counts, presence/absence data, oridinal or biomass data. This package includes functions for **visualising data, fitting predictive models, checking model assumptions, as well as testing hypotheses about the community–environment association**.
...
### mvabund in action
Here are a selection of published studies that uses `mvabund` in their analyses
