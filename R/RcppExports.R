...
RtoGlmAnova <- function(sparam, rparam, Y, X, O, isXvarIn, exPitRes, bID, lambda) {
    .Call('mvabund_RtoGlmAnova', PACKAGE = 'mvabund', sparam, rparam, Y, X, O, isXvarIn, exPitRes, bID, lambda)
}
